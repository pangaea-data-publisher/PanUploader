...
public:
    ...
    int createJubanyThumbnails( const QStringList &FilenameList, const QString &WorkingDirectory, const QString &User_hssrv2, const QString &Password_hssrv2, const QString &User_pangaea, const QString &Password_pangaea, const QString &CommandFile );
