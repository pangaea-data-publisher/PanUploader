...
cp -R './build-PanUploader-Desktop_Qt_5_9_1_clang_64bit-Release/PanUploader.app' '../../Distribution/PanUploader/PanUploader.app'
cp './trunk/Resources/Info.plist' '../../Distribution/PanUploader/PanUploader.app/Contents/Info.plist'

/Developer/Qt/5.9.1/clang_64/bin/macdeployqt '../../Distribution/PanUploader/PanUploader.app'
...
codesign --force --verify --sign 'Developer ID Application: Alfred-Wegener-Institut fur Polar- und Meeresforschung (AWI)' '../../Distribution/PanUpLoader/PanUpLoader.app/Contents/Frameworks/QtSvg.framework'
...
codesign --force --verify --sign 'Developer ID Application: Alfred-Wegener-Institut fur Polar- und Meeresforschung (AWI)' '../../Distribution/PanUpLoader/PanUpLoader.app/Contents/PlugIns/iconengines/libqsvgicon.dylib'

codesign --force --verify --sign 'Developer ID Application: Alfred-Wegener-Institut fur Polar- und Meeresforschung (AWI)' '../../Distribution/PanUploader/PanUploader.app'
